...
function (angular, _, kbn) {
  ...
  module.factory('SparkyDatasource', function($q, backendSrv, templateSrv) {

    function SparkyDatasource(datasource) {
      this.type = 'sparky';
      this.editorSrc = 'app/features/sparky/partials/query.editor.html';
    ...
    SparkyDatasource.prototype.query = function(options) {
      ...
      return this.performTimeSeriesQuery(queries, start, end).then(function(response) {
        ...
        return { data: result, mData:response.data};
      });
    };

    SparkyDatasource.prototype.performTimeSeriesQuery = function(queries, start, end) {
      var reqBody = {
        start: start,
        queries: queries
      };
    ...
    SparkyDatasource.prototype.performSuggestQuery = function(query, type) {
      var options = {
        method: 'GET',
        url: this.url,
        params: {
    ...
    SparkyDatasource.prototype.testDatasource = function() {
